...
export default function MainContainer({ children }: { children: React.ReactNode }) {
    ...
    return (
        <>
            <button onClick={() => setOpen(!open)} type="button" className="z-50 absolute top-8 left-3 w-fit p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400">
